...
Two middleware functions are provided by default in the `stats-viewer.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `stats-viewer.handler` namespace to manage the enabled middleware.
